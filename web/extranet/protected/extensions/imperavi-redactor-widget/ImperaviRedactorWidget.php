...
class ImperaviRedactorWidget extends CInputWidget
{
	...
	public function init()
	{
		...
		Yii::app()->clientScript->registerScriptFile($publicPath .'/plugins/video/video.js');
	...
	protected function registerClientScript()
	{
		...
		$this->options = array_merge(array( 
			'fileUpload' => Yii::app()->createAbsoluteUrl('//site/upload',array('type'=>'file', 'model'=>get_class($this->model))),
			'imageUpload' => Yii::app()->createAbsoluteUrl('//site/upload',array('type'=>'image', 'model'=>get_class($this->model))),
			'lang' => 'pt_br',
			'minHeight' => 500,
		),$this->options);
