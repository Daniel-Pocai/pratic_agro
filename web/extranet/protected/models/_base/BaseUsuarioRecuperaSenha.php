...
/**
 * This is the model base class for the table "cliente_recupera_senha".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "UsuarioRecuperaSenha".
 *
 * Columns in table "cliente_recupera_senha" available as properties of the model,
 * and there are no model relations.
 *
 * @property integer $idusuario_recupera_senha
...
abstract class BaseUsuarioRecuperaSenha extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('idusuario_recupera_senha, habilitar, ip, data_solicitacao, idusuario, email, token, data_validade, utilizado, utilizado_ip, utilizado_data', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			'idusuario_recupera_senha' => Yii::t('app', 'Idcliente Recupera Senha'),
			'habilitar' => Yii::t('app', 'Habilitar'),
			'ip' => Yii::t('app', 'Ip'),
			'data_solicitacao' => Yii::t('app', 'Data Solicitacao'),
			'idusuario' => Yii::t('app', 'Idcliente'),
	...
	public function search() {
		...
		$criteria->compare('idusuario_recupera_senha', $this->idusuario_recupera_senha);
