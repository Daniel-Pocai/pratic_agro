        ...
        <div class="wrapper-page animated fadeInDown">
            <div class="panel panel-color panel-inverse">
				...
				?>                  
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <?php echo $form->passwordField($model,'senha',array('placeholder'=>'Senha','class'=>'form-control')); ?>
                        </div>
                    </div>
                    <div class="form-group text-right">
                        <div class="col-xs-12">
                            <button class="btn btn-inverse w-md" type="submit">Entrar</button>
                        </div>
                    </div>
                    <div class="form-group m-t-30">
                        <div class="col-sm-7">
                            <a href="<?=$this->createUrl('esqueci_senha');?>"><i class="fa fa-lock m-r-5"></i> Esqueceu sua senha?</a>
                        </div>
                    </div>
                <?php $this->endWidget(); ?>
            </div>
