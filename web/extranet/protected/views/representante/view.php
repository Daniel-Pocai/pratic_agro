		  ...
		  ?>          
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="grid-container">
				  		<?=Util::formataTexto($model->nome)?>                 	</div>
               	  </div>
           		</div>
                    		                  <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="grid-container">
				  		<img src="<?php echo Yii::app()->createAbsoluteUrl('thumbnail/fill/250/Representante/'.$model->foto);?>"/>                 	</div>
               	  </div>
           		</div>
                <div class="form-group">
					<div class="row">
                        ...
                        <div class="col-md-4">
                            <?=Util::formataTexto($model->getAttributeLabel('regiao_atuacao'));?></dt>
                            <div class="grid-container">
                            <?=Util::formataTexto($model->getRegiaoAtuacao())?>    
                        </div>
               	    </div>
           		</div>
           <div class="row">
        	...
        	<?
            if(Yii::app()->user->obj->perfil->temPermissaoAction('cliente','index')){
                ?>
                <div class="row">
              		<div class="col-md-12">
			    	<?php echo GxHtml::encode($model->getRelationLabel('clientes')); ?></dt>
                    <div class="grid-container">
                    <?php
